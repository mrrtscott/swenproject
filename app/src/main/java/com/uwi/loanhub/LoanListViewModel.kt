...
class LoanListViewModel : ViewModel(){
    ...
    init {
        ...
        loan.add(Loans(0, sagicor,"Ready Loan", 100000,0.5,"5 Years", 100.0, 90, "This is an example of a des."))
        loan.add(Loans(1, jmmb,"Ready Loan", 200000,1.5,"4 Years", 90.0, 90, "This is an example of a des."))
        loan.add(Loans(2, ncb,"Ready Loan", 300000,2.5,"4 Years", 100.0, 70, "This is an example of a des."))
        loan.add(Loans(3, firstglobal,"Ready Loan", 400000,3.5,"7 Years", 80.0, 30, "This is an example of a des."))
        loan.add(Loans(4, jn,"Ready Loan", 500000,4.5,"9 Years", 70.0, 50, "This is an example of a des."))
        loan.add(Loans(5, victoriamutal,"Ready Loan", 600000,5.5,"6 Years", 100.0, 80, "This is an example of a des."))
        loan.add(Loans(6, cibc,"Ready Loan", 700000,6.5,"2 Years", 90.0, 100, "This is an example of a des."))
        loan.add(Loans(7, cibc,"Ready Loan", 900000,7.5,"5 Years", 90.0, 100, "This is an example of a des."))
